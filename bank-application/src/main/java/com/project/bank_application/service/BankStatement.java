...
public class BankStatement {
    ...
    public List<Transaction> generateStatement(String accountNumber, String startDate,
        ...
        String customerName = user.getName() + " " + user.getLastName() + " " + user.getOtherName();

        // Generate statement of account in PDF
        ...
        PdfPCell bankName =  new PdfPCell(new Phrase("Company Name"));
        bankName.setBorder(0);
        bankName.setBackgroundColor(BaseColor.BLUE);
        bankName.setPadding(20f);

        PdfPCell bankAddress = new PdfPCell(new Phrase("Company Address"));
        bankName.setBorder(0);
        ...
        emailDetails.setMessageBody("Kindly find tour requested account statement attached!");
